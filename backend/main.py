...
def build_answer(message: str) -> str:
    ...
    if intent == "pest":
        if any(w in m for w in ["koleroga","areca","supari","bunch rot"]):
            return (
                ...
                "- Severe cases: Drench base with Metalaxyl + Mancozeb 3g per litre water\n"
        ...
        if any(w in m for w in ["weevil","coconut weevil","red palm","bore hole"]):
            return (
                ...
                "Severe attack: Fell and burn infested palms to stop spread\n"
        ...
        if any(w in m for w in ["thrips","chilli pest","mite","silver","curl"]):
            return (
                "**Chilli Thrips and Mite Management**\n\n"
                ...
                "- Imidacloprid 17.8 SL - 0.3ml per litre (heavy infestation)\n\n"
        ...
        if any(w in m for w in ["aphid","sticky","honeydew"]):
            return (
                ...
                "Wear gloves. Spray early morning 6-9 AM.\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            )
        ...
        if any(w in m for w in ["armyworm","fall armyworm","whorl","caterpillar"]):
            return (
                ...
                "- Organic option: Bt (Bacillus thuringiensis) 2g per litre - safe and effective\n\n"
        ...
        return (
            ...
            "- Chilli Thrips: Spinosad 0.3ml per litre or Abamectin\n"
            ...
            "Always: Wear gloves and mask. Spray early morning 6-9 AM.\n"
            "Kisan Call Centre: 1800-180-1551 (Free)"
        )
    ...
    if intent == "fertilizer":
        FERT = {
            ...
            "chilli":    "Chilli (per hectare): NPK 100:50:50 kg/ha + FYM 20 t/ha.\nBoron spray 0.2% at flowering improves fruit set by 20-30%.",
            ...
            "cotton":    "Cotton (per hectare): NPK 150:75:75 kg/ha.\nStop excess Nitrogen after boll formation. Boron 0.2% at squaring stage.",
        ...
        return (
            ...
            "- NPK 17:17:17: Balanced, good for all growth stages.\n"
    ...
    if intent == "irrigation":
        if any(w in m for w in ["arecanut","areca","supari"]):
            return (
                ...
                "- Jun-Oct (monsoon): No irrigation needed if rainfall more than 50mm per week\n\n"
                "Best method: Drip irrigation at base of palm - saves 50% water\n"
                "Critical stages: Bunch development (Mar-May) - never let soil dry completely\n\n"
        ...
        if any(w in m for w in ["coconut","tengu"]):
            return (
                ...
                "Signs of water stress: Yellow leaves, reduced nut size, premature nut drop.\n"
    ...
    if intent == "market":
        prices = {
            ...
            "onion":    ("Rs.1,000-Rs.2,800", "Nashik APMC. Price very volatile. FPO collective selling gives better price."),
            ...
            "tomato":   ("Rs.500-Rs.5,000", "Highly volatile. Sell Feb-May for best price. Bangalore APMC."),
        }
        crop_hint = ""
        ...
        return (
            ...
            "- Chilli: Rs.8,000-Rs.22,000/qt (Guntur)\n"
    ...
    if intent == "schemes":
        ...
        if any(w in m for w in ["pmfby","fasal bima","insurance","crop insurance"]):
            return (
                ...
                "Covers: Drought, flood, pest attack, hailstorm, disease losses.\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            )
    ...
    if intent == "soil":
        ...
        lines.append("\nGeneral soil advice:")
        lines.append("- Laterite soil (coastal): pH 4.5-5.5, acidic. Apply lime 3-4 t/ha. Good for arecanut, coconut, coffee.")
    ...
    if intent == "crop":
        CROP_INFO = {
            "arecanut": (
                ...
                "Key risk: Koleroga disease in monsoon - spray Bordeaux mixture 1% before June\n"
            ...
            "coconut": (
                ...
                "Support: CPCRI (Central Plantation Crops Research Institute)\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            ),
            "banana": (
                ...
                "Risk: Panama wilt - use resistant varieties, apply Trichoderma at planting\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            ),
            "paddy": (
                "**Paddy/Rice Farming:**\n\n"
                ...
                "Key disease: Blast - spray Tricyclazole 0.6g/L at 25 + 45 days\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            ),
            "coffee": (
                "**Coffee Farming:**\n\n"
                ...
                "Key disease: Leaf rust - spray Copper oxychloride 3g/L at onset of monsoon\n"
                "Support: Coffee Board India, Coorg and Chikkamagaluru markets\n"
                "Kisan Call Centre: 1800-180-1551 (Free)"
            ),
            "turmeric": (
                "**Turmeric Farming:**\n\n"
                ...
                "Key risk: Rhizome rot - grow on raised beds, treat seed with Metalaxyl\n"
            ...
            "pepper": (
                ...
                "Key risk: Phytophthora quick wilt - improve drainage, drench with Metalaxyl\n"
        ...
        if 6 <= month <= 10:
            return (
                "**Recommended Kharif Crops (June-October):**\n\n"
                ...
                "- Chilli: AP/Telangana, Rs.8,000-Rs.22,000/qt at Guntur\n"
        ...
        if month >= 11 or month <= 3:
            return (
                "**Recommended Rabi Crops (November-March):**\n\n"
        ...
        return (
            "**Recommended Summer/Zaid Crops (April-June):**\n\n"
